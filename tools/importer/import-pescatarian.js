...
// PARSER IMPORTS
import cardIndividualParser from './parsers/card-individual.js';
...
// PARSER REGISTRY
const parsers = {
  'card-individual': cardIndividualParser,
};

// PAGE TEMPLATE CONFIGURATION
// Pescatarian variant of the recipe listing: each recipe is emitted as its own
// individual `card` block (see parsers/card-individual.js) rather than a single
// shared cards grid block. Single section (title + filter pills + card grid).
const PAGE_TEMPLATE = {
  name: 'pescatarian',
  description: 'Albertsons pescatarian recipe listing — each recipe rendered as its own individual card block.',
  urls: [
    'https://www.albertsons.com/recipes/diet/pescatarian',
  ],
  blocks: [
    {
      name: 'card-individual',
      instances: [
